...
public class Sandwiches_Adapter extends RecyclerView.Adapter<Sandwiches_Adapter.ViewHolder> {
    ...
    public Sandwiches_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
    ...
    @NonNull
    @Override
    public Sandwiches_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Sandwiches_Adapter.ViewHolder holder, int position) {
