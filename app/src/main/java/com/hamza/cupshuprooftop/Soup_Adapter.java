...
public class Soup_Adapter extends RecyclerView.Adapter<Soup_Adapter.ViewHolder> {
    ...
    public Soup_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
