...
public class Shakes_Adapter extends RecyclerView.Adapter<Shakes_Adapter.ViewHolder> {
    ...
    public Shakes_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
