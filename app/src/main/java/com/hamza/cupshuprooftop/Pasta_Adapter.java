...
public class Pasta_Adapter extends RecyclerView.Adapter<Pasta_Adapter.ViewHolder> {
    ...
    public Pasta_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
    ...
    @NonNull
    @Override
    public Pasta_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Pasta_Adapter.ViewHolder holder, int position) {
