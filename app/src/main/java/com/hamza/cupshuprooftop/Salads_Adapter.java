...
public class Salads_Adapter extends RecyclerView.Adapter<Salads_Adapter.ViewHolder> {
    ...
    public Salads_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
