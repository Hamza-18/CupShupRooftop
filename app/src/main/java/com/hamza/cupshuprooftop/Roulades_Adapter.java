...
public class Roulades_Adapter extends RecyclerView.Adapter<Roulades_Adapter.ViewHolder> {
    ...
    public Roulades_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
