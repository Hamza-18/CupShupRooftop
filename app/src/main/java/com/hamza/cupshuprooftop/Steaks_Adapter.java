...
public class Steaks_Adapter extends RecyclerView.Adapter<Steaks_Adapter.ViewHolder> {
    ...
    public Steaks_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
