...
public class Frappes_Adapter extends RecyclerView.Adapter<Frappes_Adapter.ViewHolder> {
    ...
    public Frappes_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
