...
public class Burgers_Adapter extends RecyclerView.Adapter<Burgers_Adapter.ViewHolder> {
    ...
    public Burgers_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
    ...
    @NonNull
    @Override
    public Burgers_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Burgers_Adapter.ViewHolder holder, int position) {
