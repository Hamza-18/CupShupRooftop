...
public class Fish_Adapter extends RecyclerView.Adapter<Fish_Adapter.ViewHolder> {
    ...
    public Fish_Adapter(ArrayList<Integer> image, ArrayList<String> itemName, ArrayList<String> itemPrice) {
        itemImage = image;
